...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'tenant' => \App\Http\Middleware\TenantRoleMiddleware::class,
        ...
        'make.complain.access' => \App\Http\Middleware\MakeComplainCheckMiddleware::class,
        ...
        'boarding.reapprove.access' => \App\Http\Middleware\BoardingReapproveMiddleware::class,
