...
let udpateInvoiceStatus = (invoiceStatus, invoiceID) => {
  fetch('udpateInvoiceStatus', {
    method: 'POST',
    headers: {
...
<template>
    ...
    <div class="w-1/4 ">
        <input class="w-1/3 text-center" type="radio" name="checkInvoiceStatus" value="approve" v-on:click="udpateInvoiceStatus('Approved',invoice.invoice_id)">
        <input class="w-1/3 text-center" type="radio" name="checkInvoiceStatus" value="reject"  v-on:click="udpateInvoiceStatus('Rejected',invoice.invoice_id)">
